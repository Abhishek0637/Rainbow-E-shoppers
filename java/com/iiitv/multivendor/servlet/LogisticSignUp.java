...
import com.iiitv.multivendor.service.impl.LogisticServiceImpl;


/**
 * Servlet implementation class LogisticSignUp
 */
public class LogisticSignUp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LogisticSignUp() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			...
			LogisticServiceImpl logistic = new LogisticServiceImpl();
		    boolean output = logistic.logisticSignUp(dto);
			if (output) 
			{
